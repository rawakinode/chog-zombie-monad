...
export default class DungeonScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.ENEMY_TYPES = {
            1: { key: 'enemy1', hp: 40, speed: 70, scale: 0.22 },
            2: { key: 'enemy2', hp: 80, speed: 90, scale: 0.25 },
            3: { key: 'enemy3', hp: 300, speed: 100, scale: 0.32 },
        ...
        for (let wave = 1; wave <= 100; wave++) {
            this.WAVE_CONFIG[wave] = {
                1: Math.ceil(2 + wave * 0.5),
                2: Math.ceil(1 + wave * 0.4),
                3: Math.ceil(1 + wave * 0.3),
                4: Math.ceil(1 + wave * 0.25),
                5: Math.ceil(1 + wave * 0.25),
                6: Math.ceil(1 + wave * 0.25),
            };
        }
